...
export default function Playground({ onSubmitted }: { onSubmitted: () => void }) {
  ...
  const [payload, setPayload] = useState(JSON.stringify(SAMPLES["tier-2 approval ($12.4k)"], null, 2));
    ...
    <div className="pg-grid">
      <div className="card pg-card">
        ...
        <div className="fld">
          ...
          <select className="inp" value={scenario} onChange={(e) => setScenario(e.target.value)}>
